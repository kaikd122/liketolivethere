...
function ReviewStub({ review }: ReviewStubProps) {
  ...
  return (
    <div className="flex flex-row gap-2 w-full ">
      ...
      >
        <div className="flex flex-col gap-2 md:justify-start md:text-left w-full md:w-1/3">
          <span className="text-2xl line-clamp-1 pt-1 ">{review.title}</span>
          <div className="grid grid-cols-2  md:w-2/3 justify-start  items-center ">
            <span className="text-petal">
              {metresToKm(review.distance || 0)} km
            </span>
        ...
        <div className="md:w-2/3 font-light w-full h-full p-2">
